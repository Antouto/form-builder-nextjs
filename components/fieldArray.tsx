...
import { Control, FieldValues, FormState, useFieldArray, UseFormRegister, UseFormWatch } from "react-hook-form";
...
export interface props {
    ...
    displayForm: any;
    setDisplayForm: (value: number) => any;
}

export default function Fields({ control, register, setValue, getValues, formState, formState: { errors }, watch, displayForm, setDisplayForm }: props) {
